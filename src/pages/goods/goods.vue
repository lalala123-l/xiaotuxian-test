<template>
    <scroll-view enable-back-to-top scroll-y class="viewport">
        ...
        <view class="goods">
            <!-- 商品主图 -->
            <view class="preview">
                <swiper @change="onChange" circular class="swiper">
        ...
        <view class="detail panel">
            ...
            <view class="content">
                ...
                <!-- 图片详情 -->
                <image class="image" v-for="item in goods?.details.pictures" :key="item" mode="widthFix" :src="item">
                </image>
            </view>
        </view>
...
import type {
    ...
    SkuPopupInstance,
    SkuPopupLocaldata,
} from '@/uni_modules/vk-data-goods-sku-popup/components/vk-data-goods-sku-popup'
...
const onChange = (item: any) => {
    currentIndex.value = item.detail.current
}
const onTapImage = (item: any) => {
